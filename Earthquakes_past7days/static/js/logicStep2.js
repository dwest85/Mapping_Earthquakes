...
let torontoHoods = "https://raw.githubusercontent.com/dwest85/Mapping_Earthquakes/JSON_URL/JSON_URL/torontoNeighborhoods.json";
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJSON(data, {
    ...
    pointToLayer: function(magnitude, latlng) {
                console.log(data);
...
// //Grabbing torontohoods geoJSON data
